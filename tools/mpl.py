""" Matplotlib helper functions
    Stolen from https://gist.github.com/syrte/592a062c562cd2a98a83
    Edited to return collections for use with `ax.add_collection(...)`
"""
...
__all__ = ['arcs', 'circles', 'ellipses', 'rectangles']


def arcs(x, y, w, h=None, rot=0.0, theta1=0.0, theta2=360.0, c='b', vmin=None, vmax=None, **kwargs):
	"""
